...
class SpecificationComponent(ConfiguredBaseModel):
    ...
    description: Optional[str] = Field(None, description="""description of the specification component""", json_schema_extra = { "linkml_meta": {'alias': 'description',
...
class TransformationSpecification(SpecificationComponent):
    ...
    id: Optional[str] = Field(None, description="""Unique identifier for this transformation specification""", json_schema_extra = { "linkml_meta": {'alias': 'id',
         'domain_of': ['TransformationSpecification'],
         'slot_uri': 'schema:identifier'} })
    title: Optional[str] = Field(None, description="""human readable title for this transformation specification""", json_schema_extra = { "linkml_meta": {'alias': 'title',
         'domain_of': ['TransformationSpecification'],
    ...
    prefixes: Optional[Dict[str, KeyVal]] = Field(default_factory=dict, description="""maps prefixes to URL expansions""", json_schema_extra = { "linkml_meta": {'alias': 'prefixes',
         'domain_of': ['TransformationSpecification'],
         'slot_uri': 'sh:declare'} })
    source_schema: Optional[str] = Field(None, description="""name of the schema that describes the source (input) objects""", json_schema_extra = { "linkml_meta": {'alias': 'source_schema', 'domain_of': ['TransformationSpecification']} })
    target_schema: Optional[str] = Field(None, description="""name of the schema that describes the target (output) objects""", json_schema_extra = { "linkml_meta": {'alias': 'target_schema', 'domain_of': ['TransformationSpecification']} })
    class_derivations: Optional[Dict[str, ClassDerivation]] = Field(default_factory=dict, description="""Instructions on how to derive a set of classes in the target schema from classes in the source schema.""", json_schema_extra = { "linkml_meta": {'alias': 'class_derivations', 'domain_of': ['TransformationSpecification']} })
...
class ElementDerivation(SpecificationComponent):
    ...
    expression_to_expression_mappings: Optional[Dict[str, KeyVal]] = Field(default_factory=dict, description="""A mapping table in which the keys and values are expressions""", json_schema_extra = { "linkml_meta": {'alias': 'expression_to_expression_mappings',
         'domain_of': ['ElementDerivation']} })
    mirror_source: Optional[bool] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'mirror_source', 'domain_of': ['ElementDerivation']} })
    description: Optional[str] = Field(None, description="""description of the specification component""", json_schema_extra = { "linkml_meta": {'alias': 'description',
         'domain_of': ['SpecificationComponent'],
         'slot_uri': 'dcterms:description'} })
    implements: Optional[List[str]] = Field(default_factory=list, description="""A reference to a specification that this component implements.""", json_schema_extra = { "linkml_meta": {'alias': 'implements', 'domain_of': ['SpecificationComponent']} })
...
class ClassDerivation(ElementDerivation):
    ...
    populated_from: Optional[str] = Field(None, description="""Name of the class in the source schema""", json_schema_extra = { "linkml_meta": {'alias': 'populated_from',
...
class AliasedClass(ConfiguredBaseModel):
    ...
    alias: str = Field(..., description="""name of the class to be aliased""", json_schema_extra = { "linkml_meta": {'alias': 'alias', 'domain_of': ['AliasedClass']} })
    class_named: Optional[str] = Field(None, description="""local alias for the class""", json_schema_extra = { "linkml_meta": {'alias': 'class_named', 'domain_of': ['AliasedClass']} })
...
class SlotDerivation(ElementDerivation):
    ...
    name: str = Field(..., description="""Target slot name""", json_schema_extra = { "linkml_meta": {'alias': 'name',
         'domain_of': ['ElementDerivation',
                       'SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
    populated_from: Optional[str] = Field(None, description="""Source slot name""", json_schema_extra = { "linkml_meta": {'alias': 'populated_from',
         'domain_of': ['ClassDerivation',
                       'SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
    ...
    expr: Optional[str] = Field(None, description="""An expression to be evaluated on the source object to derive the target slot. Should be specified using the LinkML expression language.""", json_schema_extra = { "linkml_meta": {'alias': 'expr',
         'domain_of': ['SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
    range: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'range', 'domain_of': ['SlotDerivation'], 'slot_uri': 'linkml:range'} })
    unit_conversion: Optional[UnitConversionConfiguration] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'unit_conversion', 'domain_of': ['SlotDerivation']} })
    inverse_of: Optional[Inverse] = Field(None, description="""Used to specify a class-slot tuple that is the inverse of the derived/target slot. This is used primarily for mapping to relational databases or formalisms that do not allow multiple values. The class representing the repeated element has a foreign key slot inserted in that 'back references' the original multivalued slot.""", json_schema_extra = { "linkml_meta": {'alias': 'inverse_of', 'domain_of': ['SlotDerivation']} })
    hide: Optional[bool] = Field(None, description="""True if this is suppressed""", json_schema_extra = { "linkml_meta": {'alias': 'hide',
         'domain_of': ['SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
...
class EnumDerivation(ElementDerivation):
    ...
    name: str = Field(..., description="""Target enum name""", json_schema_extra = { "linkml_meta": {'alias': 'name',
         'domain_of': ['ElementDerivation',
                       'SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
    populated_from: Optional[str] = Field(None, description="""Source enum name""", json_schema_extra = { "linkml_meta": {'alias': 'populated_from',
         'domain_of': ['ClassDerivation',
                       'SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
...
class PermissibleValueDerivation(ElementDerivation):
    ...
    name: str = Field(..., description="""Target permissible value text""", json_schema_extra = { "linkml_meta": {'alias': 'name',
         'domain_of': ['ElementDerivation',
                       'SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
    expr: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'expr',
         'domain_of': ['SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
    populated_from: Optional[str] = Field(None, description="""Source permissible value""", json_schema_extra = { "linkml_meta": {'alias': 'populated_from',
         'domain_of': ['ClassDerivation',
                       'SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
    sources: Optional[List[str]] = Field(default_factory=list, json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['ClassDerivation',
                       ...
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
    hide: Optional[bool] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'hide',
         'domain_of': ['SlotDerivation',
                       'EnumDerivation',
                       'PermissibleValueDerivation']} })
    copy_directives: Optional[Dict[str, CopyDirective]] = Field(default_factory=dict, json_schema_extra = { "linkml_meta": {'alias': 'copy_directives', 'domain_of': ['ElementDerivation']} })
...
class UnitConversionConfiguration(ConfiguredBaseModel):
    ...
    target_unit: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'target_unit', 'domain_of': ['UnitConversionConfiguration']} })
    target_unit_scheme: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'target_unit_scheme',
         'domain_of': ['UnitConversionConfiguration'],
         'examples': [{'value': 'ucum'}]} })
    source_unit: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'source_unit', 'domain_of': ['UnitConversionConfiguration']} })
    source_unit_scheme: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'source_unit_scheme',
         'domain_of': ['UnitConversionConfiguration'],
         'examples': [{'value': 'ucum'}]} })
    source_unit_slot: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'source_unit_slot', 'domain_of': ['UnitConversionConfiguration']} })
    source_magnitude_slot: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'source_magnitude_slot', 'domain_of': ['UnitConversionConfiguration']} })
    target_unit_slot: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'target_unit_slot', 'domain_of': ['UnitConversionConfiguration']} })
    target_magnitude_slot: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'target_magnitude_slot', 'domain_of': ['UnitConversionConfiguration']} })


class StringificationConfiguration(ConfiguredBaseModel):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/linkml/transformer'})

    delimiter: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'delimiter',
         'domain_of': ['StringificationConfiguration'],
         'examples': [{'value': ','}, {'value': '|'}, {'value': ';'}]} })
    reversed: Optional[bool] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'reversed', 'domain_of': ['StringificationConfiguration']} })
    ...
    syntax: Optional[SerializationSyntaxType] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'syntax',
         'domain_of': ['StringificationConfiguration'],
...
class Inverse(ConfiguredBaseModel):
    ...
    slot_name: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'slot_name', 'domain_of': ['Inverse']} })
...
class KeyVal(ConfiguredBaseModel):
    ...
    key: str = Field(..., json_schema_extra = { "linkml_meta": {'alias': 'key', 'domain_of': ['KeyVal']} })
    value: Optional[Any] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'value', 'domain_of': ['KeyVal']} })
...
class CopyDirective(ConfiguredBaseModel):
    ...
    element_name: str = Field(..., json_schema_extra = { "linkml_meta": {'alias': 'element_name', 'domain_of': ['CopyDirective']} })
    copy_all: Optional[bool] = Field(None, description="""Copy all sub-elements of the Element being derived.""", json_schema_extra = { "linkml_meta": {'alias': 'copy_all', 'domain_of': ['CopyDirective']} })
    exclude_all: Optional[bool] = Field(None, description="""Do not copy any of the sub-elements of the Element being derived.""", json_schema_extra = { "linkml_meta": {'alias': 'exclude_all', 'domain_of': ['CopyDirective']} })
    exclude: Optional[Any] = Field(None, description="""Remove certain sub-elements from the list of sub-elements to be copied.
As of now there it is under-specified, how to specify the sub-elements to exclude. One possible implementation would be a list where all element types can be mixed, since there might not be name conflicts across element types.""", json_schema_extra = { "linkml_meta": {'alias': 'exclude', 'domain_of': ['CopyDirective']} })
    include: Optional[Any] = Field(None, description="""Add certain sub-elements to the list of sub-elements to be copied.
As of now there it is under-specified, how to specify the sub-elements to include. One possible implementation would be a list where all element types can be mixed, since there might not be name conflicts across element types.""", json_schema_extra = { "linkml_meta": {'alias': 'include', 'domain_of': ['CopyDirective']} })
    add: Optional[Any] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'add', 'domain_of': ['CopyDirective']} })
