...
class TransformationSpecification(SpecificationComponent):
    ...
    author: Optional[List[Union[Agent,Person,Organization,Software]]] = Field(default_factory=list, description="""A list of authors of this transformation specification""", json_schema_extra = { "linkml_meta": {'alias': 'author', 'domain_of': ['TransformationSpecification']} })
