...
class SpecificationComponent(ConfiguredBaseModel):
    ...
    description: Optional[str] = Field(default=None, description="""description of the specification component""", json_schema_extra = { "linkml_meta": {'alias': 'description',
         'domain_of': ['SpecificationComponent', 'TransformationSpecification'],
...
class TransformationSpecification(SpecificationComponent):
    ...
    description: Optional[str] = Field(default=None, description="""A description of the transformation specification, including its purpose, how it should be used, and any other relevant information.""", json_schema_extra = { "linkml_meta": {'alias': 'description',
         'domain_of': ['SpecificationComponent', 'TransformationSpecification'],
         'slot_uri': 'dcterms:description'} })
    ...
    creator_id: Optional[List[str]] = Field(default=None, description="""A list of creators of this transformation specification""", json_schema_extra = { "linkml_meta": {'alias': 'creator_id',
         'domain_of': ['TransformationSpecification'],
         'slot_uri': 'sssom:creator_id'} })
    author_id: Optional[List[str]] = Field(default=None, description="""A list of authors of this transformation specification""", json_schema_extra = { "linkml_meta": {'alias': 'author_id',
         'domain_of': ['TransformationSpecification'],
...
class KeyVal(ConfiguredBaseModel):
    ...
    value: Optional[Any] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'value', 'domain_of': ['KeyVal']} })
