...
class TransformationSpecification(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="class_derivations", slot_type=ClassDerivation, key_name="name", keyed=True
        )

        self._normalize_inlined_as_dict(
            slot_name="enum_derivations", slot_type=EnumDerivation, key_name="name", keyed=True
        )

        self._normalize_inlined_as_dict(
            slot_name="slot_derivations", slot_type=SlotDerivation, key_name="name", keyed=True
        )
...
class ElementDerivation(YAMLRoot):
    ...
    value_mappings: Optional[
        Union[Dict[Union[str, KeyValKey], Union[dict, "KeyVal"]], List[Union[dict, "KeyVal"]]]
    ] = empty_dict()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="expression_to_value_mappings", slot_type=KeyVal, key_name="key", keyed=True
        )
...
class SlotDerivation(ElementDerivation):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.cast_collection_as is not None and not isinstance(
            self.cast_collection_as, CollectionType
        ):
...
slots.slotDerivation__cast_collection_as = Slot(
    uri=LINKMLTR.cast_collection_as,
    name="slotDerivation__cast_collection_as",
    curie=LINKMLTR.curie("cast_collection_as"),
    model_uri=LINKMLTR.slotDerivation__cast_collection_as,
    domain=None,
    range=Optional[Union[str, "CollectionType"]],
)
...
slots.enumDerivation__permissible_value_derivations = Slot(
    ...
    range=Optional[
        Union[
            Dict[
                Union[str, PermissibleValueDerivationName], Union[dict, PermissibleValueDerivation]
            ],
            List[Union[dict, PermissibleValueDerivation]],
        ]
    ],
