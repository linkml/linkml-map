...
class MappingSet(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(slot_name="entities", slot_type=Entity, key_name="id", keyed=True)
...
slots.subject = Slot(uri=MAPPINGS.subject, name="subject", curie=MAPPINGS.curie('subject'),
                   model_uri=MAPPINGS.subject, domain=None, range=Optional[Union[str, EntityId]])

slots.object = Slot(uri=MAPPINGS.object, name="object", curie=MAPPINGS.curie('object'),
                   model_uri=MAPPINGS.object, domain=None, range=Optional[Union[str, EntityId]])
...
slots.mappingSet__entities = Slot(uri=MAPPINGS.entities, name="mappingSet__entities", curie=MAPPINGS.curie('entities'),
                   model_uri=MAPPINGS.mappingSet__entities, domain=None, range=Optional[Union[Dict[Union[str, EntityId], Union[dict, Entity]], List[Union[dict, Entity]]]])
