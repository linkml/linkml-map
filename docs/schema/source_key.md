...
_column in the primary (populated_from) table used as the join key_
...
URI: [linkmlmap:source_key](https://w3id.org/linkml/transformer/source_key)
...
| ---  | ---  |
| self | linkmlmap:source_key |
| native | linkmlmap:source_key |
