...
URI: [linkmlmap:source_magnitude_slot](https://w3id.org/linkml/transformer/source_magnitude_slot)
...
| ---  | ---  |
| self | linkmlmap:source_magnitude_slot |
| native | linkmlmap:source_magnitude_slot |
