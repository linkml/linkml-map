...
# Slot: unmelt_to_class 


_In an unmelt operation, attributes (which are values in the long/melted/EAV representation) must conform to valid attributes in this class_
...
URI: [linkmlmap:unmelt_to_class](https://w3id.org/linkml/transformer/unmelt_to_class)
...
| Property | Value |
| --- | --- |
| Range | [ClassReference](ClassReference.md) |
...
| ---  | ---  |
| self | linkmlmap:unmelt_to_class |
| native | linkmlmap:unmelt_to_class |
